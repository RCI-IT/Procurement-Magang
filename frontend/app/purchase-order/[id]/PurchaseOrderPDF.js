...
export const PurchaseOrderPDF = ({
  ...
  if (!data || !PurchaseDetails) return null;
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerRow}>
          ...
          <View>
            <Text style={styles.titlePO}>PURCHASE ORDER</Text>
            <View style={styles.container}>
              <View style={styles.row}>
                <Text style={styles.label}>Tanggal</Text>
                <Text style={styles.value}>
                  :{" "}
                  {new Date(data?.tanggalPO).toLocaleDateString("id-ID", {
                    day: "2-digit",
                    month: "long",
                    year: "numeric",
                  })}
              ...
              <View style={styles.row}>
                ...
                <Text style={styles.value}>: {data.nomorPO}</Text>
              </View>
              <View style={styles.row}>
              ...
              <View style={styles.row}>
                ...
                <Text style={styles.value}>
                  : {data?.confirmationOrder?.nomorCO || "-"}
                </Text>
              </View>
              {data?.keterangan && (
                <View style={styles.row}>
        ...
        <View style={styles.suplierContainer}>
          <Text style={styles.suplierTitle}>SUPPLIER</Text>
          <View style={styles.row}>
            <Text style={styles.suplierLabel}>Nama</Text>
            <Text style={styles.suplierValue}>
              : {data.confirmationOrder?.vendor?.name}
            </Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.suplierLabel}>Alamat</Text>
            <Text style={styles.suplierValue}>
          ...
          <View style={styles.row}>
            <Text style={styles.suplierLabel}>No. Telepon</Text>
            <Text style={styles.suplierValue}>
              : {data.confirmationOrder?.vendor?.phone}
            </Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.suplierLabel}>Reference</Text>
            <Text style={styles.suplierValue}>: {data.keterangan}</Text>
          </View>
        </View>
